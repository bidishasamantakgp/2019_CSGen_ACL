...
from . import train
from . import getembeddings_generic
...
def add_arguments(parser):
  ...
  parser.add_argument("--share_vocab", type="bool", nargs="?", const=True,
      ...
      target.\
      """)
  parser.add_argument("--get_embeddings", type="bool", default=False,
                      help="""\
      Whether to display the embeddings of a given source and destination.\
      """)
  ...
  #                      help="contains english sentences")
  # Sequence lengths
...
def create_hparams(flags):
  ...
  return tf.contrib.training.HParams(
      ...
      # get embeddings
      get_embeddings=flags.get_embeddings,
      #segment_file=flags.segment_file,
      #english_sentence=flags.english_sentence,
...
def run_main(flags, default_hparams, train_fn, embedding_fn, inference_fn, target_session=""):
  """Run main."""
  # Job
  jobid = flags.jobid
  ...
  if flags.inference_input_file:
    ...
    if hparams.get_embeddings == True:
      embedding_fn(hparams, target_session=target_session)
    else:
      # Train
...
def main(unused_argv):
  ...
  embedding_fn = getembeddings_generic.main_embeddings
  inference_fn = inference.inference
  run_main(FLAGS, default_hparams, train_fn, embedding_fn, inference_fn)
